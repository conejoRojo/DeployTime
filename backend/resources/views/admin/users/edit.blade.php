    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="role" name="role" required>
                    <option value="user" {{ $user->role == 'user' ? 'selected' : '' }}>User (Colaborador)</option>
            ...
            <div class="mb-4 bg-yellow-50 p-4 rounded">
                ...
                <label class="block text-gray-700 text-sm font-bold mb-2" for="password">Nueva Contraseña (Opcional)</label>
